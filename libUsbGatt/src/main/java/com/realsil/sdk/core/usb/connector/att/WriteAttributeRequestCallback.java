 ...
 * @author xp.chen
 */
public abstract class WriteAttributeRequestCallback {
    ...
    /**
     * This callback method will be called when the {@link com.realsil.sdk.core.usb.connector.att.impl.WriteAttributeRequest} is sent failed.
     *
