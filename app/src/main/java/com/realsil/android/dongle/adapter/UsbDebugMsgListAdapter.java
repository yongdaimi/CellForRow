...
public class UsbDebugMsgListAdapter extends RecyclerView.Adapter<UsbDebugMsgListAdapter.VH> {
    ...
    public UsbDebugMsgListAdapter(Context context, List<UsbMsg> msgList) {
